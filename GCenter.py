...
def fetch_incidents():
    ...
    r = requests.get("https://10.2.107.21/api/v1/alerts/", headers={"API-KEY": "19GlWC5tREQgJzS9R33EF2TLgWnN-DMByV6XFc-XehWLIvUTCQnHgIQJ37arUxQprNliPqPcNBp-LrvTgbB-HCWJBSgK6bBBp7O0EiTuNgJLcFYdql_fJUBH2B7EgfSoCJYYsMpaWE-UP7MEg2aCLpYpYWsHOfENDRu8lgreiQM"}, verify=False)

    demisto.incidents(r.json())
